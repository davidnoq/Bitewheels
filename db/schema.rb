...
ActiveRecord::Schema[7.2].define(version: 2024_12_19_225119) do
  ...
  create_table "user_event_application_reads", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "event_application_id", null: false
    ...
    t.index ["event_application_id"], name: "index_user_event_application_reads_on_event_application_id"
    t.index ["user_id"], name: "index_user_event_application_reads_on_user_id"
  end
  ...
  add_foreign_key "user_event_application_reads", "event_applications"
  add_foreign_key "user_event_application_reads", "users"
end
